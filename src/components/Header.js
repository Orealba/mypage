...
const Header = () => {
  return (
    <div>
      <div
        className="flex bg-no-repeat   bg-contain max-w-screen max-h-screen sm:bg-contain md:bg-contain  lg:bg-contain xl:bg-contain 2xl:bg-auto  header__background"
