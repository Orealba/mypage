      ...
      <div className="container mx-auto">
        ...
        <div className="md:flex">
          ...
          <div className="text-justify">
            <div>
              <p className="">
                I am a <strong>Full-Stack developer</strong>, a graduate of
                4Geeks Academy, with experience in journalism and social media.
                I have had the opportunity to learn various programming
                languages such as
                <strong> HTML, JavaScript (React), CSS, Python</strong>, among
                others, which has allowed me to create innovative projects that
